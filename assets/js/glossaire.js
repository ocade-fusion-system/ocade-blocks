document.addEventListener('DOMContentLoaded', function () {
  ...
  form.innerHTML = `<p>Termes à rechercher dans le glossaire</p><input id="glossaire-search" name="q" placeholder="Automatisation, Cloud Computing, ..." type="search" title="Filtrer les termes recherchés dans le glossaire" />`;
